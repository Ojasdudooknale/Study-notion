...
function ReviewSlider() {
    ...
    return (
        <div className="text-white">
            <div className="my-8 max-w-maxContentTab lg:max-w-maxContent">
                <Swiper
                    slidesPerView={1}
                    spaceBetween={25}
                    loop={true}
                ...
                >
                    {reviews.map((review, index) => (
                        <SwiperSlide key={index} className="mb-4">
                            <div className="flex flex-col gap-3 bg-richblack-800 p-3 text-sm text-richblack-25 rounded-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <h2 className="text-xs font-medium text-richblack-500">{review.course.courseName}</h2>
                                    </div>
                                </div>
